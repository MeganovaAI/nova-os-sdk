...
> ⚠️ **License Notice**
>
> The **LibraOS server** is provided for **evaluation and development use** under the Business Source License. **Production deployments require a commercial license** — contact support@libraos.com for pricing before pinning to production.
>
