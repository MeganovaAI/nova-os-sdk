...
HMAC scheme matches Nova OS's Go `internal/callbacks/dispatcher.go`:
the signing input is `ts + "." + tool_use_id + "." + body`. Signature
header format is `t=<unix>,v1=<hex>`. Replay window default 5 min.
